...
${BIN}/tree-extract.py --tree ${TAB}/roadies_v1.1.16b.nwk --table ${TAB}/VGPPhase1-freeze-1.0.tsv --category Lineage --value Birds --outgroups 2 --suffix-category "Scientific Name" --ignore Amphibians > birds-v1.nwk
