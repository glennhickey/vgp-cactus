...
${BIN}/tree-extract.py --tree ${TAB}/roadies_v1.1.16b.nwk --table ${TAB}/VGPPhase1-freeze-1.0.tsv --category Superorder --value "Actinopterygii (Ray-finned Fishes)" --outgroups 2 --suffix-category "Scientific Name"  > rayfin-fish-v1.nwk
