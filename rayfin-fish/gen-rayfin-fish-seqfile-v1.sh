...
${BIN}/tree-extract.py --tree ${TAB}/roadies_v1.1.16b.nwk --table ${TAB}/annotations.tsv --category Superorder --value "Actinopterygii (Ray-finned Fishes)" --outgroups 2 --suffix-category ScientificName  > rayfin-fish-v1.nwk
