...
cactus-phast jobstore/js-phast-hg38-ssrev-vertebrates vgp-577way-v1-hg38.single.maf.gz vgp-577way-v1.hal GCA_000001405.15 conservation/GCA_000001405.15/vgp-577way-v1-hg38.single.phyloP.ssrev.wig.gz --root VertebratesAnc0 --geneAnnotation https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/genes/hg38.knownGene.gtf.gz --substMod SSREV --modFreqs --precision HIGH --bigwig --batchSystem slurm --chunkCores 32 --phyloFitCores 64 --slurmPartition medium --doubleMem true --slurmTime 11:00:00 --retryCount 5 --maxMemory 1Ti --disableProgress --logFile vgp-577way-v1-prep/logs/vgp-577way-v1-hg38.ssrev.rVertebratesAnc0.phyloP.log &

cactus-phast jobstore/js-phast-hg38-ssrev-mammals vgp-577way-v1-hg38.single.maf.gz vgp-577way-v1.hal GCA_000001405.15 conservation/GCA_000001405.15/vgp-577way-v1-hg38.single.phyloP.ssrev.wig.gz --root MammalsAnc0 --geneAnnotation https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/genes/hg38.knownGene.gtf.gz --substMod SSREV --modFreqs --precision HIGH --bigwig --batchSystem slurm --chunkCores 32 --phyloFitCores 64 --slurmPartition medium --doubleMem true --slurmTime 11:00:00 --retryCount 5 --maxMemory 1Ti --disableProgress --logFile vgp-577way-v1-prep/logs/vgp-577way-v1-hg38.ssrev.rMammalsAnc0.phyloP.log &

cactus-phast jobstore/js-phast-hg38-ssrev-primates vgp-577way-v1-hg38.single.maf.gz vgp-577way-v1.hal GCA_000001405.15 conservation/GCA_000001405.15/vgp-577way-v1-hg38.single.phyloP.ssrev.wig.gz --root PrimatesAnc0 --geneAnnotation https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/genes/hg38.knownGene.gtf.gz --substMod SSREV --modFreqs --precision HIGH --bigwig --batchSystem slurm --chunkCores 32 --phyloFitCores 64 --slurmPartition medium --doubleMem true --slurmTime 11:00:00 --retryCount 5 --maxMemory 1Ti --disableProgress --logFile vgp-577way-v1-prep/logs/vgp-577way-v1-hg38.ssrev.rPrimatesAnc0.phyloP.log &

cactus-phast jobstore/js-phast-hg38-ssrev-subtrees vgp-577way-v1-hg38.single.maf.gz vgp-577way-v1.hal GCA_000001405.15 conservation/GCA_000001405.15/vgp-577way-v1-hg38.single.phyloP.ssrev.wig.gz --subtree Anc0 MammalsAnc0 PrimatesAnc0 --geneAnnotation https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/genes/hg38.knownGene.gtf.gz --substMod SSREV --modFreqs --precision HIGH --bigwig --batchSystem slurm --chunkCores 32 --phyloFitCores 64 --slurmPartition medium --doubleMem true --slurmTime 11:00:00 --retryCount 5 --maxMemory 1Ti --disableProgress --logFile vgp-577way-v1-prep/logs/vgp-577way-v1-hg38.ssrev.subtrees.phyloP.log &

cactus-phast jobstore/js-phast-mm39 vgp-577way-v1-mm39.single.maf.gz vgp-577way-v1.hal GCA_000001635.9 conservation/GCA_000001635.9/vgp-577way-v1-mm39.single.phyloP.wig.gz --geneAnnotation https://hgdownload.soe.ucsc.edu/goldenPath/mm39/bigZips/genes/mm39.ncbiRefSeq.gtf.gz --substMod REV --modFreqs --precision HIGH --bigwig --batchSystem slurm --chunkCores 32 --phyloFitCores 64 --slurmPartition medium --doubleMem true --slurmTime 11:00:00 --retryCount 5 --maxMemory 1Ti --disableProgress --logFile vgp-577way-v1-prep/logs/vgp-577way-v1-mm39.phyloP.log &
