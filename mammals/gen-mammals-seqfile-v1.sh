...
${BIN}/tree-extract.py --tree ${TAB}/roadies_v1.1.4.nwk --table ${TAB}/annotations.tsv --category Lineage --value Mammals --outgroups 2 --suffix-category ScientificName --ignore Amphibians > mammals-v1.nwk
